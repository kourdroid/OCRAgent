...
async def health() -> dict:
    ...
    async def _check_tables() -> dict[str, object]:
        try:
            # ⚡ Bolt Optimization:
            # Replaced expensive direct asyncpg.connect() with get_connection_pool.
            # This avoids TCP/TLS handshake overhead on every /health check,
            # drastically reducing latency and load for this high-frequency endpoint.
