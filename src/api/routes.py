...
async def health() -> dict:
    ...
    async def _check_tables() -> dict[str, object]:
        try:
            # ⚡ BOLT OPTIMIZATION: Use connection pool instead of creating a new connection
            # for each health check to avoid expensive TCP/TLS handshake and auth overhead.
