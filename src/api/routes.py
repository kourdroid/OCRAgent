...
async def health() -> dict:
    ...
    async def _check_tables() -> dict[str, object]:
        try:
            # ⚡ Bolt Optimization:
            # Replaced expensive direct asyncpg.connect() with the shared connection pool.
            # This prevents a costly TCP/TLS handshake and authentication process
            # for every health check ping, dramatically reducing load on the database.
